...
export class Simulation {
     ...
     */
    attach_canvas(canvas_id) {
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.simulation_attach_canvas(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    /**
     * @param {number} producer_speed
     * @param {number} consumer_speed
     */
    tick(producer_speed, consumer_speed) {
        wasm.simulation_tick(this.__wbg_ptr, producer_speed, consumer_speed);
    }
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./lockless_datastructures_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lockless_datastructures_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
